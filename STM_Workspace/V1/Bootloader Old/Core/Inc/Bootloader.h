...
#define LAST_COMMEND                            0x16 ////////////////////change it to 0x17

#define NumberOfCommends                        0x07 /////////////change it to 8
...
#define FLASH_PAGE_BASE_ADDRESS_APP             0x08004400U /////////////////ADD anther one and change it according to your 2 APPS, FLASH_PAGE_BASE_ADDRESS_APP1 and FLASH_PAGE_BASE_ADDRESS_APP2

/* To check that the given address is within range */
#define ADDRESS_IS_VALID                        1
#define ADDRESS_IS_INVALID                      0
#define ADDRESS_BL_ACK_LENGTH                   1
...
#define APPLICATION_SIZE                        7 /////////////////ADD anther one and change it according to your 2 APPS, APPLICATION1_SIZE and APPLICATION2_SIZE
